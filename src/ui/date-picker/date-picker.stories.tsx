		...
		<div style={{ padding: 20, display: "grid", gap: 12, maxWidth: 520 }}>
			...
			>
				...
				<div style={{ opacity: 0.8, lineHeight: 1.5 }}>
					<div>
						- mode가 <b>year-month</b> 인 경우, 선택 결과는 <b>YYYY-MM</b> 로 정규화됩니다.
					</div>
					<div>
						- mode가 <b>year-month-day</b> 인 경우, 선택 결과는 <b>YYYY-MM-DD</b> 입니다.
					</div>
				</div>
			</div>
		</div>
...
const meta: Meta<typeof DateFieldDemo> = {
	...
	argTypes: {
		...
		selectableRange: {
			...
			description: "날짜 선택 범위를 설정합니다.",
		},
		startYear: {
			control: "number",
			description: "연도 셀렉트의 시작 연도입니다. (예: 1950)",
		},
		endYear: {
			control: "number",
			description: "연도 셀렉트의 마지막 연도입니다. (예: 현재연도+10)",
		},
		disabled: {
			control: "boolean",
			description: "비활성화 상태입니다. 전체 선택 요소가 disabled 됩니다.",
		},
		defaultValue: {
			control: "text",
			description:
			...
			<div style={{ padding: 20, display: "grid", gap: 12, maxWidth: 520 }}>
				...
				<div style={{ display: "grid", gap: 6, fontSize: 13 }}>
					...
					<div style={{ lineHeight: 1.6, opacity: 0.85 }}>
						- 시작값이 <code>2026-01-31</code> 입니다.
						<br />- 월을 2월로 바꾸면 2월에는 31일이 없기 때문에, 일(day)이 유효한 값으로 보정될 수
						있습니다.
						<br />- 실제 보정 정책은 제품 UX에 맞춰 조정 가능합니다.
					</div>
