    ...
    render: () => (
        <div style={{ display: "grid", gap: 16, maxWidth: 480 }}>
            ...
            {Object.entries(skeleton.height).map(([key, height]) => (
                <div key={key} style={{ display: "grid", gridTemplateColumns: "60px 1fr", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ display: "grid", gap: 24, maxWidth: 720, gridTemplateColumns: "1fr 1fr" }}>
            ...
            {[0, 1].map((i) => (
                ...
                >
                    ...
                    <SkeletonBlock width="70%" height={skeleton.height.md} borderRadius={skeleton.radius.sm} />
                </div>
            ))}
        </div>
    ),
...
export const ProfileExample: Story = {
    ...
    render: () => (
        <div style={{ maxWidth: 360 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, padding: 16, border: "1px solid #e5e5e5", borderRadius: 12 }}>
                {/* 아바타 */}
                <div
                    style={{
                        flexShrink: 0,
                ...
                <div style={{ flex: 1, display: "grid", gap: 8 }}>
                    <SkeletonBlock width="60%" height={skeleton.height.lg} borderRadius={skeleton.radius.sm} />
                    <SkeletonBlock height={skeleton.height.md} borderRadius={skeleton.radius.sm} />
                </div>
            </div>
        </div>
            ...
            {Array.from({ length: 4 }).map((_, i) => (
                ...
                >
                    ...
                    <div style={{ display: "grid", gap: 6 }}>
                        <SkeletonBlock width={`${60 + i * 8}%`} height={skeleton.height.md} borderRadius={skeleton.radius.sm} />
                        <SkeletonBlock width={`${40 + i * 5}%`} height={skeleton.height.sm} borderRadius={skeleton.radius.sm} />
                    </div>
                </div>
            ))}
        </div>
