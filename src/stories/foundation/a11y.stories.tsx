		...
		<div style={{ display: "grid", gap: 24, maxWidth: 720 }}>
			...
			<section>
				...
				<div style={{ display: "flex", gap: 16, marginTop: 12 }}>
					<button type="button" style={focusButtonStyle(a11y.focusRing)}>기본 포커스</button>
					<button type="button" style={focusButtonStyle(a11y.focusRingError)}>에러 상태</button>
					<button type="button" style={focusButtonStyle(a11y.focusRingSuccess)}>성공 상태</button>
				</div>

				<ul style={{ marginTop: 12, fontSize: 13, opacity: 0.8 }}>
					<li>
						<code>focusRing</code> : 기본 인터랙션 포커스
					</li>
					<li>
						<code>focusRingError</code> : 오류 상황 강조
					</li>
					<li>
						<code>focusRingSuccess</code> : 완료 / 정상 상태 강조
					</li>
				</ul>
			</section>
			...
			<section>
				...
				<p style={{ opacity: 0.8 }}>모바일에서 손가락으로 누르기 충분한 최소 크기 기준입니다.</p>
