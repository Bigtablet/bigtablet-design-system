 ...
 */
export const Checkbox = ({ label, size = "md", indeterminate, className, ref, ...props }: CheckboxProps) => {
    const inputRef = React.useRef<HTMLInputElement>(null);

    React.useImperativeHandle(ref as React.Ref<HTMLInputElement>, () => inputRef.current!);
