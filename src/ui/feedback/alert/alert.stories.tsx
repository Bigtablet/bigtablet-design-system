...
### Destructive 패턴
\`destructive={true}\` 사용 시 **확인 버튼이 빨간 강조(danger)** 로 표시되어 위험성을 시각적으로 명확히 전달합니다. 취소 버튼은 outline으로 약한 강조 유지. (Material / shadcn / Radix 표준 패턴 — 빨간 버튼 = 위험한 액션)
...
export const Destructive: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"destructive 패턴에선 confirm이 빨간 filled(danger)로 강조 — 위험성을 시각적으로 명확히 표시. cancel은 outline으로 덜 강조.",
			},
		},
	},
};
