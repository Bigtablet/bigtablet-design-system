...
function radiusUseCase(key: string) {
    switch (key) {
        case "none": return "표, 인라인 UI";
        case "xs":   return "작은 뱃지, 인디케이터";
        case "sm":   return "뱃지, 태그, 얇은 카드";
        case "md":   return "버튼, 입력창, 기본 카드";
        case "lg":   return "모달, 큰 패널";
        case "xl":   return "강조 카드, 히어로 영역";
        case "full": return "아바타, 토글, 원형 버튼";
        default:     return "공통 UI";
    }
}
