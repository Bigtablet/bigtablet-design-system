...
import { borderWidth, baseBorderWidth } from "src/styles/ts/border-width";
...
function borderWidthDescription(key: string) {
    switch (key) {
        case "none":      return "테두리 없음";
        case "standard":  return "카드, 인풋, 구분선";
        case "indicator": return "포커스 링, 선택 상태, 탭 인디케이터";
        default:          return "";
    }
}
