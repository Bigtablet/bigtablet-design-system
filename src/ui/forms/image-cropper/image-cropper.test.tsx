...
/**
 * ImageCropperProps 가 Omit<HTMLAttributes<HTMLDivElement>, "onError" | "children" |
 * "dangerouslySetInnerHTML"> 를 확장해 소비자의 표준 div 속성을 루트로 전달하되,
 * 내부 className·공개 onError(이미지) 는 보존하는지 검증.
 */
